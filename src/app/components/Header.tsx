    ...
    return (
        <header className={styles.header}>
            <div className={styles.logo}>
                {/* Replaced the logo with SVG */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 396.11 197.92" className="svelte-md2ju7">
            ...
            <div className={styles.text}> {/* Aggiunto il testo momentaneo */}
                {/* Testo responsivo */}
                <span>Testo momentaneo</span>
            </div>
